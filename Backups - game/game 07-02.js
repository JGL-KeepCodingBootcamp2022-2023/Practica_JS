...
export default {
    ...
    setUpGame: {  // funciones de inicio del juego      
        ...
        push(player, coords){
            switch(this.pos) {
                case this.pos = 1:
                    player.ships[1].BUQUE.position.push(Object.assign([], coords));
                    break;
                case this.pos = 2:
                    player.ships[2].SUBMARINO.position.push(Object.assign([], coords));
                    break;
                case this.pos = 3:
                    player.ships[3].SUBMARINO.position.push(Object.assign([], coords));
                    break;
                case this.pos = 4:
                    player.ships[4].CRUCERO.position.push(Object.assign([], coords));
                    break;
                case this.pos = 5:
                    player.ships[5].CRUCERO.position.push(Object.assign([], coords));
                    break;
                case this.pos = 6:
                    player.ships[6].CRUCERO.position.push(Object.assign([], coords));
                    break;
                case this.pos = 7:
                    player.ships[7].LANCHA.position.push(Object.assign([], coords));
                    break;
                case this.pos = 8:
                    player.ships[8].LANCHA.position.push(Object.assign([], coords));
                    break;
                case this.pos = 9:
                    player.ships[9].LANCHA.position.push(Object.assign([], coords));
                    break;
                default :
                    player.ships[0].PORTAAVIONES.position.push(Object.assign([], coords));        
            }
        },

        place(player, barco, coords, gridSize, playerGrid, a, push){
            for (let i = 0; i < barco.life; i++){
                playerGrid[coords[1]][coords[0]] = barco.figure;
                if (a == 'Par'){
                    ++coords[0]
                    this.push(player, coords)               
                }
                else {
                    ++coords[1]
                }  
